...
programmes~\cite{ntnfrac} and as joint beam-direction and resource problems in dynamic LEO
...
trajectory planning~\cite{qpsouav,qpsomulti} and, more recently, to trajectory optimisation in
...
The right panel of Fig.~\ref{fig:verdict} places each method difference against the spread
...
\bibitem{ntnfrac}
Non-terrestrial network (NTN): a novel alternate fractional programming for the downlink
channels power allocation. arXiv:2401.10251 (2024)
...
\bibitem{qpsomulti}
Multi-strategy quantum particle swarm optimization for efficient path planning.
J. Supercomput. (2025). DOI 10.1007/s11227-025-07901-8
